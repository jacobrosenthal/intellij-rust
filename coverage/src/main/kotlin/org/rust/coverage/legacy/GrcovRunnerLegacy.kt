...
package org.rust.coverage.legacy
...
class GrcovRunnerLegacy : DefaultProgramRunner() {
    ...
    override fun canRun(executorId: String, profile: RunProfile): Boolean {
        ...
        return !CargoBuildManager.isBuildToolWindowEnabled && CargoBuildManager.getBuildConfiguration(profile) != null
    }
    ...
    companion object {
        private val LOG: Logger = Logger.getInstance(GrcovRunnerLegacy::class.java)

        const val RUNNER_ID: String = "GrcovRunnerLegacy"
